...
public class ListAdapterDetails<Model> extends ArrayAdapter {
...
//	TextView att4 = null;
	...
	public ListAdapterDetails(Context context, int resource, int textViewResourceId, ArrayList<PicatchModelDetails> items) {
...
//}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = convertView;
//ViewHolder h;
        PicatchModelDetails p = (PicatchModelDetails)getItem(position);
...
//				v.setTag(h);
        ...
        try {
	        if (p != null) {
	        	...
	        	TextView tt1 = (TextView) v.findViewById(R.id.editText1_l_2);
	        	TextView tt2 = (TextView) v.findViewById(R.id.editText1_l_1);
	        	TextView tt3 = (TextView) v.findViewById(R.id.editText1_l_3);
